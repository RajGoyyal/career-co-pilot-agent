...
const SKILL_TAXONOMY: Record<string, { category: "technical" | "soft" | "domain"; keywords: string[] }> = {
  ...
  "Business Strategy": { category: "domain", keywords: ["strategy", "strategic planning", "market entry", "business model", "competitive analysis"] },
  "Financial Analysis": { category: "domain", keywords: ["financial analysis", "financial modeling", "valuation", "dcf", "profitability", "excel modeling"] },
  "Stakeholder Management": { category: "soft", keywords: ["stakeholder", "client management", "executive alignment", "stakeholder management"] },
  "Market Research": { category: "domain", keywords: ["market research", "market sizing", "consumer insights", "competitive research", "survey analysis"] },
  "Operations Management": { category: "domain", keywords: ["operations", "process optimization", "supply chain", "lean", "six sigma"] },
  "Sales Enablement": { category: "domain", keywords: ["sales enablement", "sales training", "go-to-market", "revenue operations", "sales playbook"] },
  "People Management": { category: "soft", keywords: ["people management", "team management", "talent development", "coaching", "performance reviews"] },
  "Customer Empathy": { category: "soft", keywords: ["customer empathy", "user empathy", "customer centric", "customer obsession"] },
  "Risk Management": { category: "domain", keywords: ["risk management", "program risk", "mitigation plan", "issue tracking", "governance"] },
};
...
export const ROLE_TEMPLATES: Record<string, { requiredSkills: { name: string; level: Skill["level"] }[]; description: string; salaryRange: string; demandLevel: DreamRole["demandLevel"] }> = {
  ...
  "Management Consultant": {
    ...
    description: "Diagnose business challenges and craft strategic recommendations across industries",
  ...
  "Product Marketing Manager": {
    ...
    description: "Build compelling narratives, launches, and go-to-market strategies for products",
    salaryRange: "$95K - $165K",
    demandLevel: "medium",
  },
  "Customer Success Manager": {
    requiredSkills: [
      { name: "Communication", level: "advanced" },
      { name: "Stakeholder Management", level: "advanced" },
      { name: "Customer Empathy", level: "advanced" },
      { name: "Sales Enablement", level: "intermediate" },
      { name: "Problem Solving", level: "intermediate" },
      { name: "People Management", level: "beginner" },
      { name: "Project Management", level: "intermediate" },
    ],
    description: "Drive retention and expansion by guiding customers to measurable value",
  ...
  "Operations Manager": {
    ...
    description: "Optimize processes, teams, and systems to unlock operational excellence",
    salaryRange: "$90K - $160K",
    demandLevel: "medium",
  },
  "UX Researcher": {
    ...
    description: "Uncover user insights through qualitative and quantitative research to inform design",
    salaryRange: "$85K - $150K",
    demandLevel: "high",
  },
  "IT Program Manager": {
    ...
    description: "Lead multi-team technology initiatives from concept to launch with cross-functional alignment",
    salaryRange: "$110K - $180K",
    demandLevel: "high",
  },
};
