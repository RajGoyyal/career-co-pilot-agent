...
export function NavigationPane() {
  ...
  return (
    <aside
      ...
      className={cn(
        "fixed bottom-4 left-4 z-50 rounded-2xl border border-border/70 bg-card/90 text-foreground shadow-2xl backdrop-blur-xl transition-all",
        isCollapsed
    ...
    >
      {isCollapsed ? (
        <Button
          ...
          aria-label="Expand navigation pane"
        >
